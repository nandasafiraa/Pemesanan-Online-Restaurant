	...
	<div id="wrapper">
		...
		<!-- LEFT SIDEBAR -->
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?=base_url('index.php/Dashboard_user/index')?>" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="<?=base_url('index.php/Order_user/index')?>" class=""><i class="lnr lnr-chart-bars"></i> <span>Order</span></a></li>
						<li><a href="<?=base_url('index.php/Order_user/index')?>" class=""><i class="lnr lnr-chart-bars"></i> <span>Cart</span></a></li>

						<li><a href="<?=base_url('index.php/Logout_user/index')?>" class=""><i class="lnr lnr-cog"></i> <span>Logout</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
