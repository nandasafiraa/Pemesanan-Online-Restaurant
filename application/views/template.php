					...
					<ul class="nav">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle icon-menu" data-toggle="dropdown">
								<i class="lnr lnr-dice"></i><span>Tabel</span>
							</a>
							<ul class="dropdown-menu notifications">
								<li><a href="<?=base_url('index.php/Masakan/index')?>" class="notification-item"><span class="dot bg-warning"></span>Masakan</a></li>
								<li><a href="<?=base_url('index.php/Pelanggan/index')?>" class="notification-item"><span class="dot bg-danger"></span>Pelanggan</a></li>
								<li><a href="<?=base_url('index.php/User/index')?>" class="notification-item"><span class="dot bg-success"></span>User</a></li>
							</ul>
						</li>
						<li><a href="<?=base_url('index.php/Order/index')?>" class=""><i class="lnr lnr-chart-bars"></i> <span>Order</span></a></li>
